...
public class SJFNonPreemptive {
    ...
    public SJFNonPreemptive(ArrayList<Process> processList, JTextArea outputArea, GanttChartPanel ganttChartPanel, DefaultTableModel tableModel, ArrayList<String> ganttChartLabels, ArrayList<Integer> ganttChartTimes) {
    ...
    public void startSimulation() {
        outputArea.append("Starting Shortest Job First non-preemptive Simulation \n");
