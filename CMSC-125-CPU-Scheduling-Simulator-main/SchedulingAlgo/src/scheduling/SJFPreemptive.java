...
public class SJFPreemptive {
    ...
    public SJFPreemptive(ArrayList<Process> processList, JTextArea outputArea, GanttChartPanel ganttChartPanel, DefaultTableModel tableModel, ArrayList<String> ganttChartLabels, ArrayList<Integer> ganttChartTimes) {
    ...
    public void startSimulation() {
        outputArea.append("Starting Shortest Job First preemptive Simulation \n");
