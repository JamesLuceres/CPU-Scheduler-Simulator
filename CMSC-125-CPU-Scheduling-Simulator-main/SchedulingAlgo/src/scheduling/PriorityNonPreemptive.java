...
public class PriorityNonPreemptive {
    ...
    public PriorityNonPreemptive(ArrayList<Process> processList, JTextArea outputArea, GanttChartPanel ganttChartPanel, DefaultTableModel tableModel, ArrayList<String> ganttChartLabels, ArrayList<Integer> ganttChartTimes) {
    ...
    public void startSimulation() {
        outputArea.append("Starting Priority non-preemptive Simulation \n");
